...
angular.module('planillasApp')
  .controller('EliminarregistrosCtrl', function ($scope,$rootScope,$http2,URLS) {
    ...
    },function(){},"ELIMINAR GESTION ACADEMICA","Seguro que desea eliminar registro de Gestion Academica?");
    };
    ...
    $rootScope.removeLogs = function(log){
      ...
      },function(){},"ELIMINAR LOGS","Seguro que desea eliminar registro?");
    };
