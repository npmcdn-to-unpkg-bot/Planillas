...
angular.module('planillasApp')
    .controller('VerplanillaCtrl', function ($scope, $rootScope, $http2, URLS, $http, $q, $modal, $log, $timeout) {
        ...
        $rootScope.generarPlanilla = function (page, items_for_page, forceWeeks, forceHoras_trabajo) {
        ...
        $rootScope.load_docentes = function () {
            $rootScope.GF.load_lista_docentes(function (data) {
            }, function () {
            }, 'idCarrera=' + ($rootScope.filters.filter_carrera || ''))
        };
        $rootScope.load_materias = function () {
            $rootScope.GF.load_lista_materias(function (data) {
                }, function () {
                },
        ...
        $rootScope.NUMERO_HORAS_DISPONIBLE = [];
        for (var i = 1; i <= 500; i++) {
            $rootScope.NUMERO_HORAS_DISPONIBLE.push(i);
        }
